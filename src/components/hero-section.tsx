...
export default function HeroSection() {
  ...
  return (
    <>
      <section className="relative flex flex-col md:flex-row items-center justify-center px-8 md:px-24 overflow-hidden ">
        <div className={cn(
        ...
        <div className="relative z-10 lg:max-w-2xl md:max-w-lg">
          <div className="absolute flex flex-col items-center justify-center top-0 right-56 space-y-6 scale-75 ">
          ...
          <div className={cn(
            "pt-64 md:mt-0 lg:ml-16 text-left space-y-5",
            ...
            <p className="text-neutral-300 leading-relaxed text-justify">
              Me chamo <span className="font-semibold text-white text-lg">Gustavo Galvão</span>,
